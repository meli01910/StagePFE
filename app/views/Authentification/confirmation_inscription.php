            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <?php if(isset($_SESSION['inscription_data'])): ?>
                        <h3 class="text-center mb-4">Merci, <?= htmlspecialchars($_SESSION['inscription_data']['prenom']) ?> !</h3>
                    ...
                    <?php else: ?>
                        <h3 class="text-center mb-4">Merci pour votre inscription !</h3>
...
<?php
// Nettoyage des données d'inscription après affichage
