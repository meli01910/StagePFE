...
<option value="Attaquant" <?= (strcasecmp(trim($utilisateur['poste'] ?? ''), 'Attaquant') === 0) ? 'selected' : '' ?>>Attaquant</option>
    ...
    <select class="form-select" id="niveau_jeu" name="niveau_jeu" required>
        ...
        <option value="debutant" <?= ($utilisateur['niveau_jeu'] ?? '') == 'debutant' ? 'selected' : '' ?>>Débutant</option>
        <option value="amateur" <?= ($utilisateur['niveau_jeu'] ?? '') == 'amateur' ? 'selected' : '' ?>>Amateur</option>
        <option value="confirme" <?= ($utilisateur['niveau_jeu'] ?? '') == 'confirme' ? 'selected' : '' ?>>Confirmé</option>
        <option value="expert" <?= ($utilisateur['niveau_jeu'] ?? '') == 'expert' ? 'selected' : '' ?>>Expert</option>
    </select>
</div>
